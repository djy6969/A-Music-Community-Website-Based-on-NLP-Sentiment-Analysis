<template>
  <div class="page-wrapper">
    ...
    <section class="hero-area bgc-gray rel z-1">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 align-self-center">
            <div
              class="hero-content pt-115 pb-125 rpb-0 wow fadeInUp delay-0-4s"
            >
              <h1>Affordable Big IT & Technology Solutions</h1>
              <p>
                Bring On Monday, the innovative small business online accounting
                services that both you and your bottom line will love.
              </p>
              <a href="/" class="theme-btn mt-20 wow fadeInUp delay-0-6s"
                >Let’s Get Started <i class="fas fa-long-arrow-right"></i
              ></a>
      ...
      <div class="hero-shapes">
        <img
          class="shape bg-lines"
          src="@/assets/images/shapes/hero-bg-line-shapes.png"
          alt="Shape"
        />
        <img
          class="shape right-shape wow fadeInRight delay-0-8s"
    ...
    <section class="partners-area mt-60 pt-150 pb-100 rmt-30 rpb-70 rel z-1">
      <div class="container">
        ...
        <div
          class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 justify-content-center"
        >
          <div class="col">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
            <div class="about-images">
              <div class="top-part">
                <img
                  class="wow fadeInRight delay-0-3s"
                  src="@/assets/images/about/about1.jpg"
                  alt="About"
                />
                <img
                  class="wow zoomIn delay-0-5s"
              ...
              <div class="bottom-part">
                <img
                  class="wow fadeInDown delay-0-5s"
                  src="@/assets/images/about/about-dots.png"
                  alt="About"
                />
                <img
                  class="wow fadeInDown delay-0-3s"
    ...
    <!-- Project Area start -->
    <section
      class="project-area overflow-hidden bgc-lighter pt-130 rpt-100 rel z-1"
    >
      <div class="container">
        ...
        <div class="project-slider-active">
          <div class="project-slider-item">
            ...
            <div class="content">
              ...
              <a href="/" class="theme-btn style-two mt-15"
                >View Details <i class="fas fa-long-arrow-right"></i
              ></a>
            </div>
          </div>
          <div class="project-slider-item">
        ...
        <div class="row medium-gap">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="service-two-item wow fadeInUp delay-0-4s">
              ...
              <div class="content">
                <h4><a href="/">Digital Consulting</a></h4>
                <p>
          ...
          <div class="col-xl-4 col-md-6">
            <div class="service-two-item wow fadeInUp delay-0-3s">
              ...
              <div class="content">
                <h4><a href="/">Mobile App Solutions</a></h4>
                <p>
                  On the other hand we denounce withteous indignation and
                  dislike men who beguilede demoralized by the charms pleasure
                </p>
          ...
          <div class="col-xl-4 col-md-6">
            <div class="service-two-item wow fadeInUp delay-0-5s">
              ...
              <div class="content">
                <h4>
                  <a href="/">UX/UI Design Strategy</a>
                </h4>
                <p>
                  On the other hand we denounce withteous indignation and
                  dislike men who beguilede demoralized by the charms pleasure
    ...
    <section class="work-process-area pt-130 pb-100 rpt-100 rpb-70 rel z-1">
      ...
      <div class="container">
        <div
          class="row row-cols-xl-5 row-cols-md-3 row-cols-sm-2 row-cols-1 justify-content-center"
        >
          <div class="col">
    ...
    <section class="statistics-area rel z-2">
      <div class="container">
        <div
          class="statistics-inner bgs-cover text-white p-80 pb-20"
          style="
            background-image: url(@/assets/images/background/statistics.jpg);
          "
        >
            ...
            <div class="col-xl-7 col-lg-6">
              <div class="row">
                <div class="col-xl-3 col-small col-6">
                  <div
                    class="counter-item counter-text-wrap wow fadeInDown delay-0-3s"
                  >
                ...
                <div class="col-xl-3 col-small col-6">
                  <div
                    class="counter-item counter-text-wrap wow fadeInUp delay-0-3s"
                  >
    ...
    <section
      class="price-plan-area bgc-lighter mt-30 rmt-0 pt-220 pb-100 rpb-70 rel z-1"
    >
          ...
          <div class="col-xl-4 col-md-6">
            <div class="pricing-plan-item wow fadeInUp delay-0-2s">
              ...
              <a href="/" class="theme-btn style-two"
                >Choose Package <i class="fas fa-long-arrow-right"></i
              ></a>
      ...
      <div class="price-shapes">
        <img
          class="shape one wow fadeInLeft delay-0-5s"
              ...
              <div class="testi-content-slider">
                <div class="testi-content-item">
                  <p>
                    ...
                    antiume dolorem queauy antium totam aperiam eaque quae
                    abillosa inventore veritatis etuarchite beatae vitaec
                    voluptas sit aspernatur autodit
                  </p>
                  <div class="author">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="blog-item style-two wow fadeInUp delay-0-2s">
              ...
              <div class="content">
                ...
                <h4>
                  <a href="/"
                    >Voice Usabilit Consideration Partially Visually Hidden</a
                  >
                </h4>
                <div class="author">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="blog-item style-two wow fadeInUp delay-0-4s">
              ...
              <div class="content">
                ...
                <h4>
                  <a href="/"
                    >How Create Vanil Java Script Gant Chart Adding Task</a
                  >
                </h4>
                <div class="author">
                  <img src="@/assets/images/blog/author.jpg" alt="Author" />
          ...
          <div class="col-xl-4 col-md-6">
            <div class="blog-item style-two wow fadeInUp delay-0-6s">
              ...
              <div class="content">
                ...
                <h4>
                  <a href="/"
                    >Smashing Podcast Episode 47 Soueidan Accessibility</a
                  >
                </h4>
                <div class="author">
                  <img src="@/assets/images/blog/author.jpg" alt="Author" />
      ...
      <div class="footer-cta-wrap">
        <div class="container">
          <div
            ...
            style="
              background-image: url(@/assets/images/footer/footer-cta-bg.jpg);
            "
          >
            ...
            <a href="/" class="theme-btn style-three wow fadeInRight delay-0-2s"
              >Get Free Quote <i class="fas fa-long-arrow-right"></i
            ></a>
